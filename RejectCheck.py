...
class RejectCheck(Request):
    ...
    def request(cursor, params, dataTransferObject):
        ...
        if row is not None and row[0] is not None:
            ...
            cursor.execute("UPDATE Examination SET goods=null, sanitation=null, security=null, consumerRights=null WHERE id = {} AND status ='inProgres'".format(id_current_exam))
